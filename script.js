...
function checkRound() {
  if (playerScore == 5 || computerScore == 5) {
    ...
    document.querySelector(".outcome").textContent = getWinner(
      playerScore,
      computerScore
    );
...
function playGame(playerSelection) {
  ...
  document.querySelector(
    ".response1"
  ).textContent = `Computer chose: ${computerSelection}.`;
  document.querySelector(
    ".response2"
  ).textContent = `You chose: ${playerSelection}.`;
  document.querySelector(".outcome").textContent = playRound(
    playerSelection,
    computerSelection
  );
  //document.querySelector('.game-info').textContent = "";
  document.querySelector(".game-info").style.visibility = "hidden";
...
function restartGame() {
  ...
  document.querySelector(".response1").innerHTML = "&nbsp;";
